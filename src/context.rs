...
pub(crate) const KEY_CLIENT_IP: &str = "client.ip";
/// Client port (`"client.port"`).
pub(crate) const KEY_CLIENT_PORT: &str = "client.port";
/// Server (local) IP address (`"server.ip"`).
pub(crate) const KEY_SERVER_IP: &str = "server.ip";
...
/// (RFC 9209).
pub(crate) fn get_server_id(ctx: &RequestContext) -> Option<String> {
