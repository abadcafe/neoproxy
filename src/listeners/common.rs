...
pub fn check_http_version(version: http::Version) -> Result<(), http::StatusCode> {
    match version {
        http::Version::HTTP_10 => Err(http::StatusCode::HTTP_VERSION_NOT_SUPPORTED),
        http::Version::HTTP_11 | http::Version::HTTP_2 | http::Version::HTTP_3 => Ok(()),
...
pub fn build_505_response() -> plugin::Response {
    let body = http_body_util::Full::new(bytes::Bytes::from("HTTP Version Not Supported"));
