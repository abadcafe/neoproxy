...
// Telemetry stubs - we don't use deno CLI's telemetry infrastructure
const builtinTracer = () => ({ startSpan: () => null });
const ContextManager = { active: () => null };
const enterSpan = () => null;
const restoreSnapshot = () => {};
const __telemetry = { TRACING_ENABLED: false, PROPAGATORS: [] };
const updateSpanFromClientResponse = () => {};
const updateSpanFromError = () => {};
const updateSpanFromRequest = () => {};
