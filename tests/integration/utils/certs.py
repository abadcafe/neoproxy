...
type CertPair = tuple[str, str]
type TestCertBundle = tuple[str, str, str, str]
...
def _load_ca(ca_cert_path: str, ca_key_path: str) -> tuple[x509.Certificate, RSAPrivateKey]:
